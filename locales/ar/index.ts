...
export const strings: TranslatableStrings = {
  ...
  "tutor.doDone": "انتهيت",
    "tutor.recordingNotApplied": "لم يستقبل معلّمك ذلك التسجيل. ابدأ الدرس من جديد.",
  "tutor.doAgain": "أعد",
  ...
  // الدرس بلا ضغط أزرار: يبقى الميكروفون مفتوحًا ويكتفي المتعلّم بالتلاوة.
  "handsfree.label": "المعلّم المباشر",
  "handsfree.start": "ابدأ المعلّم المباشر",
  "handsfree.privacy": "لا يُستعمل الميكروفون إلا أثناء هذه الجلسة، ويُترك عند الإنهاء. ولا يستمع في أي وقت آخر.",
  "handsfree.stateIdle": "لا يستمع",
  "handsfree.stateListening": "أستمع",
  "handsfree.stateSpeaking": "أنت تتلو",
  "handsfree.stateChecking": "أتحقّق",
  "handsfree.stateTeacher": "معلّمك يتكلّم",
  "handsfree.stateReciter": "القارئ يتلو",
  "handsfree.stateWaiting": "في انتظارك",
  "handsfree.statePaused": "متوقّف",
  "handsfree.stateMicUnavailable": "الميكروفون غير متاح",
  "handsfree.stateReconnect": "يحتاج هذا الدرس إلى بداية جديدة",
  "handsfree.scopeWord": "تلك الكلمة وحدها",
  "handsfree.scopeAyah": "الآية كاملة",
  "handsfree.nowYouSayIt": "قلها أنت الآن.",
  "handsfree.listenToTheWord": "أنصت إلى الكلمة.",
  "handsfree.goodContinue": "أحسنت. تابع.",
  "handsfree.carryOn": "نكمل من حيث توقّفنا.",
  "handsfree.pause": "إيقاف مؤقّت",
  "handsfree.resume": "تابع",
  "handsfree.stop": "إنهاء",
  "handsfree.options": "إن لم يسر شيء على ما يرام",
  "handsfree.repeatTeacher": "أعد ما قلت",
  "handsfree.hearWordAgain": "اسمع الكلمة مرّة أخرى",
  "handsfree.hearAyah": "اسمع الآية",
  "handsfree.hint": "أعطني تلميحًا",
  "handsfree.speakAloud": "دع المعلّم يتكلّم بصوت مسموع",
  "handsfree.voiceShown": "معروضة لا منطوقة — لا صوت في هذا المتصفّح للغتك.",
  "handsfree.sessionLost": "ضاع الدرس. ابدأه من جديد ليكمل من هذه الآية.",
  "handsfree.restart": "ابدأ من جديد",
  "handsfree.micDenied": "لم يُسمح باستعمال الميكروفون، فتمرّن بزرّ التسجيل أدناه.",
  "handsfree.micMissing": "لم يُعثر على ميكروفون، فتمرّن بزرّ التسجيل أدناه.",
  "handsfree.micUnsupported": "لا يستطيع هذا المتصفّح التسجيل، فتمرّن بزرّ التسجيل أدناه.",
  "handsfree.vadUnsupported": "لا يستطيع هذا المتصفّح الاستماع المتواصل، فتمرّن بزرّ التسجيل أدناه.",
  ...
  "qaida.listenLetter": "استمع إلى هذا الحرف",
  "qaida.audioLoading": "جارٍ تحميل التسجيل…",
  "qaida.audioRetry": "شغّله مرة أخرى",
  "qaida.audioIdle":
    "اختر حرفًا، وحده أو مع حركة. لا يُشغَّل هنا إلا تسجيل اعتمده معلّم مؤهَّل — وبقيتها لم تجهز بعد.",
  "qaida.audioPlaying": "يُشغَّل تسجيل القارئ.",
  "qaida.audioUnavailable":
    "لم يُضَف هذا التسجيل بعد. الصوت المرجعي للقاعدة يسجّله معلّم مؤهَّل ويُعتمد قبل أن يسمعه المتعلّم — ولن يقرأ التطبيق العربية بصوت مُصطنَع بدلًا منه.",
  ...
  "recorder.rateLimited": "أجريت عدة محاولات للمراجعة بسرعة. انتظر دقيقة ثم أعد تلاوة الآية.",
  ...
  "plan.qaida.afterRecordingCue": "اعتبر مراجعة الكلمات دعوة للتدريب، ثم استمع إلى القارئ المؤهل مجددًا قبل التكرار.",
  ...
  "plan.tajweed.afterRecordingCue": "استخدم المراجعة لتحديد الكلمة التي فاتت أو غير المؤكدة، ثم تدرّب على تلك العودة مع معلم مؤهل لتصحيح التجويد.",
  ...
  "feedback.coachCopy": "استمع إلى توجيه التدريب، ثم ارجع إلى القارئ المؤهل للعربية القرآنية.",
  ...
  "attemptFailure.micTooQuiet": "التقط الميكروفون صوتًا، لكنه كان خافتًا جدًا بحيث تعذّر فحصه. اقترب من الميكروفون وحاول مجددًا.",
  "attemptFailure.uncertainVerseMatch": "وصل التسجيل، لكن تعذّرت مطابقته بثقة مع هذه الآية، لذلك لم يتغيّر موضعك. حاول الآية مجددًا.",
  "validation.micPassed": "ناجح: التقط {browser} إشارة صوتية حقيقية.",
  "validation.micNoAudio": "فشل: لم ينتج المُسجِّل أي بيانات صوتية قابلة للاستخدام.",
  "validation.micTooQuiet": "فشل: تم تسجيل الصوت، لكن إشارة الميكروفون كانت خافتة جدًا.",
  "validation.micError": "فشل الفحص الأولي للميكروفون ({name}). تحقّق من أذونات الميكروفون في {browser} وحاول مجددًا.",
  ...
  "feedback.coachPerfectEncouragement": "تم التعرّف على جميع الكلمات المتوقعة. حافظ على الإيقاع الهادئ نفسه وكرّر مرة أخرى.",
  "feedback.coachGoodEncouragement": "محاولة جيدة. حافظ على الآية متماسكة، ثم عُد فقط إلى الكلمة المعلَّمة للمراجعة.",
  "feedback.coachPerfectSpoken": "تم التعرّف على كل كلمة متوقعة. {nextStep}",
  "feedback.coachGoodSpoken": "محاولة جيدة. {nextStep}",
  "feedback.nextStepRepeatFromWord": "استمع إلى المرجع ببطء، ثم كرّر ابتداءً من الكلمة {word}.",
  "feedback.nextStepReplayReference": "استمع إلى المرجع مرة بإيقاع أبطأ، ثم كرّر الآية بالوقفات نفسها.",
  "feedback.focusedInvalidEncouragement": "تعذّر ربط هذه المحاولة المركّزة بالكلمة المعلَّمة.",
  "feedback.focusedInvalidNextStep": "عُد إلى الآية الحالية واختر كلمتك المعلَّمة من جديد.",
  "feedback.focusedInvalidSpoken": "تعذّر التحقق من الكلمة المعلَّمة. عُد إلى الآية الحالية وحاول مجددًا.",
  "feedback.reviewFocusedTargetInvalid": "لم يتطابق هدف التصحيح مع الآية الحالية.",
  "feedback.unavailableEncouragement": "وصل تسجيلك، لكن لا تتوفر نتيجة موثوقة كلمةً كلمةً لهذه المحاولة.",
  "feedback.unavailableSpoken": "لا تتوفر نتيجة موثوقة كلمةً كلمةً لهذه المحاولة. استمع مرة أخرى، ثم سجّل من جديد في مكان هادئ.",
  "feedback.transcriptionFailedNextStep": "تحقق من اتصالك والميكروفون، ثم سجّل الآية من جديد. تعذّر إتمام هذه المراجعة، لكن يمكنك المحاولة الآن.",
  "feedback.noArabicNextStep": "حاول الآية مجددًا في مكان هادئ. أبقِ الميكروفون قريبًا واقرأ آية واحدة بإيقاع هادئ.",
  "feedback.focusedRecognisedNext": "تم التعرّف على الكلمة المستهدفة المتوقعة في النص. الآن اقرأ الآية كاملة.",
  "feedback.focusedNotRecognisedNext": "لم يتم التعرّف على الكلمة المستهدفة المتوقعة. استمع إلى الكلمة المعلَّمة، ثم قل تلك الكلمة فقط مجددًا.",
  "feedback.focusedUnclearNext": "كان النص المركّز غير واضح. احتفظ بالكلمة المعلَّمة وحاول تلك الكلمة مجددًا.",
  "feedback.focusedRecognisedEncouragement": "تم التعرّف على الكلمة المتوقعة.",
  "feedback.focusedKeepFocusedEncouragement": "أبقِ التصحيح مركّزًا على الكلمة المعلَّمة.",
  "feedback.reviewFocusedUnclear": "لم يقدّم النص المركّز دليلًا واضحًا عن الكلمة المستهدفة.",
  "feedback.noteFocusedTargetInvalid": "لم يُقيَّم أي صوت أو نص أو ملاحظة صوتية أو درجة للآية لأن هدف التصحيح المركّز كان غير صالح.",
  "feedback.noteFocusedTargetActive": "يبقى الهدف المركّز نشطًا. لم تُحتسب درجة للآية ولم يُدَّعَ أي حكم صوتي أو نطقي.",
  "feedback.noteNoWordScore": "لم تُحتسب درجة للكلمة في هذه المحاولة. سيُبقي التطبيق أزرار التسجيل لتتمكن من المحاولة فورًا.",
  "feedback.noteFocusedChecks": "تتحقق هذه النتيجة المركّزة فقط مما إذا تم التعرّف على الكلمة المتوقعة في النص. وهي لا تحسب درجة للآية ولا تقيّم النطق أو التجويد أو المخارج أو المدّ أو الغنّة أو الحركات صوتيًا.",
  "feedback.noteAyahAcoustic": "تذكّر الكلمات مبني على تحويل الكلام إلى نص. والملاحظة الصوتية الإضافية إرشاد تدريبي مشروط بالثقة، وليست شهادة في التجويد أو المخارج أو اللحن أو الصحة الدينية، ولا بديلًا عن معلم مؤهل.",
  "feedback.noteAyahTranscription": "هذه مساعدة على تذكّر الكلمات مبنية على تحويل الكلام إلى نص. وهي لا تحكم في التجويد أو المخارج أو طول الحروف أو اللحن، ولا تحل محل معلم مؤهل.",
