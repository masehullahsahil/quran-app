...
export const strings: TranslatableStrings = {
  ...
  "lesson.eyebrowResolved": "وہ لفظ ہو گیا",
  ...
  "lesson.hearFullAyah": "پوری آیت سنیں",
  "lesson.wordLoading": "ریکارڈنگ آ رہی ہے…",
  "lesson.wordPlaying": "قاری یہ لفظ پڑھ رہے ہیں",
  "lesson.wordUnavailable": "اس لفظ کی ریکارڈنگ نہ چل سکی۔",
  "lesson.playAyahInstead": "اس کے بجائے پوری آیت سنیں",
  "lesson.wordReferenceNote": "لفظ بہ لفظ حوالہ تلاوت — اوپر والی آیت سے مختلف قاری۔",
  ...
  "tutor.label": "آپ کے استاد",
  "tutor.ready": "جب تیار ہوں، شروع کریں۔",
  "tutor.listening": "میں سن رہا ہوں۔",
  "tutor.checking": "ایک لمحہ۔",
  "tutor.wordMissed": "ایک لفظ رہ گیا۔ سنیں۔",
  "tutor.wordRecognised": "اچھا — نشان زد لفظ مجھے سنائی دیا۔",
  ...
  "tutor.doDone": "ہو گیا",
    "tutor.recordingNotApplied": "آپ کے استاد نے وہ ریکارڈنگ نہیں لی۔ سبق دوبارہ شروع کریں۔",
  "tutor.doAgain": "دوبارہ",
  "tutor.doRepeatWord": "لفظ کہیں",
  "tutor.doHearWord": "لفظ سنیں",
  "tutor.doHearAyah": "آیت سنیں",
  "tutor.doHint": "اشارہ",
  "tutor.doFromBeginning": "شروع سے",
  "tutor.doContinue": "آگے",
  "tutor.doPause": "وقفہ",
  "tutor.doResume": "جاری رکھیں",
  "tutor.doStop": "ختم",

  // Whose turn it is, and what the teacher is doing — said in words, so the
  // state does not depend on an animation or a colour.
  "tutor.turnTeacher": "آپ کے استاد بول رہے ہیں",
  "tutor.turnLearner": "آپ کی باری",
  "tutor.presenceListening": "سن رہے ہیں",
  "tutor.presenceThinking": "جانچ رہے ہیں",
  "tutor.presenceSpeaking": "بول رہے ہیں",
  "tutor.presenceWaiting": "آپ کے منتظر",

  // Speaking to the teacher. Honest about not listening yet.
  "tutor.voiceOpen": "استاد سے بات کریں",
  "tutor.voiceTitle": "استاد سے بات کرنا",
  "tutor.voiceNotListening": "ابھی نہیں — استاد فی الحال بولی گئی ہدایات نہیں سنتے۔ جب سنیں گے تو آپ یہ کہہ سکیں گے۔ آپ کی تلاوت کو کبھی ہدایت نہیں سمجھا جاتا۔",
  "tutor.voiceClose": "بند کریں",
  "tutor.wordPosition": "لفظ {number} از {total}",
  "tutor.detailsSummary": "استاد نے کیا دیکھا",

  // بغیر ہاتھ کا سبق: مائیکروفون کھلا رہتا ہے اور طالب علم صرف تلاوت کرتا ہے۔
  "handsfree.label": "زندہ استاد",
  "handsfree.start": "زندہ استاد شروع کریں",
  "handsfree.privacy": "مائیکروفون صرف اسی نشست کے دوران استعمال ہوتا ہے اور ختم کرنے پر چھوڑ دیا جاتا ہے۔ کسی اور وقت یہ نہیں سنتا۔",
  "handsfree.stateIdle": "نہیں سن رہا",
  "handsfree.stateListening": "سن رہا ہوں",
  "handsfree.stateSpeaking": "آپ پڑھ رہے ہیں",
  "handsfree.stateChecking": "دیکھ رہا ہوں",
  "handsfree.stateTeacher": "آپ کے استاد بول رہے ہیں",
  "handsfree.stateReciter": "قاری کی تلاوت چل رہی ہے",
  "handsfree.stateWaiting": "آپ کا انتظار ہے",
  "handsfree.statePaused": "رکا ہوا",
  "handsfree.stateMicUnavailable": "مائیکروفون دستیاب نہیں",
  "handsfree.stateReconnect": "یہ سبق دوبارہ شروع کرنا ہوگا",
  "handsfree.scopeWord": "صرف وہی لفظ",
  "handsfree.scopeAyah": "پوری آیت",
  "handsfree.nowYouSayIt": "اب آپ کہیے۔",
  "handsfree.listenToTheWord": "لفظ کو سنیے۔",
  "handsfree.goodContinue": "اچھا۔ آگے بڑھیے۔",
  "handsfree.carryOn": "جہاں رکے تھے وہیں سے آگے چلتے ہیں۔",
  "handsfree.pause": "وقفہ",
  "handsfree.resume": "آگے بڑھیں",
  "handsfree.stop": "ختم",
  "handsfree.options": "اگر کچھ ٹھیک نہ ہوا",
  "handsfree.repeatTeacher": "دوبارہ کہیے",
  "handsfree.hearWordAgain": "لفظ دوبارہ سنیں",
  "handsfree.hearAyah": "آیت سنیں",
  "handsfree.hint": "کوئی اشارہ دیں",
  "handsfree.speakAloud": "استاد کو بلند آواز میں بولنے دیں",
  "handsfree.voiceShown": "دکھایا گیا، بولا نہیں گیا — اس براؤزر کے پاس آپ کی زبان کی آواز نہیں۔",
  "handsfree.sessionLost": "سبق ضائع ہو گیا۔ دوبارہ شروع کریں، اسی آیت سے آگے چلے گا۔",
  "handsfree.restart": "دوبارہ شروع",
  "handsfree.micDenied": "مائیکروفون کی اجازت نہیں ملی، اس لیے نیچے ریکارڈ کے بٹن سے مشق کریں۔",
  "handsfree.micMissing": "کوئی مائیکروفون نہیں ملا، اس لیے نیچے ریکارڈ کے بٹن سے مشق کریں۔",
  "handsfree.micUnsupported": "یہ براؤزر ریکارڈ نہیں کر سکتا، اس لیے نیچے ریکارڈ کے بٹن سے مشق کریں۔",
  "handsfree.vadUnsupported": "یہ براؤزر مسلسل نہیں سن سکتا، اس لیے نیچے ریکارڈ کے بٹن سے مشق کریں۔",
  ...
  "notes.previousAttempt": "یہ ایک پچھلی کوشش کی وضاحت ہے — سبق اس کے بعد آگے بڑھ چکا ہے۔",
  ...
  "qaida.listenLetter": "یہ حرف سنیں",
  "qaida.audioLoading": "ریکارڈنگ آ رہی ہے…",
  "qaida.audioRetry": "دوبارہ سنائیں",
  "qaida.audioIdle":
    "کوئی حرف چنیں، تنہا یا حرکت کے ساتھ۔ یہاں صرف وہی ریکارڈنگ چلتی ہے جسے کسی اہل استاد نے منظور کیا ہو — باقی ابھی تیار نہیں۔",
  "qaida.audioPlaying": "قاری کی ریکارڈنگ چل رہی ہے۔",
  "qaida.audioUnavailable":
    "یہ ریکارڈنگ ابھی شامل نہیں کی گئی۔ قاعدے کی حوالہ آواز کوئی اہل استاد ریکارڈ کرتا ہے اور سننے سے پہلے اس کی منظوری ہوتی ہے — ایپ اس کی جگہ عربی کو مصنوعی آواز میں نہیں پڑھے گی۔",
  ...
  "recorder.rateLimited": "آپ نے تھوڑی دیر میں کئی بار جانچ کی کوشش کی ہے۔ ایک منٹ انتظار کریں، پھر آیت دوبارہ پڑھیں۔",
  ...
  "plan.qaida.afterRecordingCue": "لفظوں کے جائزے کو مشق کی دعوت سمجھیں، پھر دہرانے سے پہلے اہل قاری کو دوبارہ سنیں۔",
  ...
  "plan.tajweed.afterRecordingCue": "جائزے سے وہ لفظ تلاش کریں جو چھوٹ گیا یا غیر یقینی ہے، پھر اس لوٹنے کی مشق تجوید کی اصلاح کے لیے اہل استاد کے ساتھ کریں۔",
  ...
  "feedback.coachCopy": "مشق کی ہدایت سنیں، پھر قرآنی عربی کے لیے اہل قاری سے رجوع کریں۔",
  ...
  "attemptFailure.micTooQuiet": "آپ کے مائیکروفون نے آواز پکڑی، مگر وہ جانچ کے لیے بہت دھیمی تھی۔ مائیکروفون کے قریب آئیں اور دوبارہ کوشش کریں۔",
  "attemptFailure.uncertainVerseMatch": "آپ کی ریکارڈنگ موصول ہو گئی، مگر اسے اس آیت سے اعتماد کے ساتھ ملایا نہ جا سکا، اس لیے آپ کی جگہ نہیں بدلی۔ آیت دوبارہ پڑھیں۔",
  "validation.micPassed": "کامیاب: {browser} نے حقیقی آواز کا اشارہ پکڑا۔",
  "validation.micNoAudio": "ناکام: ریکارڈر نے کوئی قابلِ استعمال آواز کا ڈیٹا پیدا نہیں کیا۔",
  "validation.micTooQuiet": "ناکام: آواز ریکارڈ ہوئی، مگر مائیکروفون کا اشارہ بہت دھیما تھا۔",
  "validation.micError": "مائیکروفون کی ابتدائی جانچ ناکام رہی ({name})۔ {browser} کی مائیکروفون اجازتیں دیکھیں اور دوبارہ کوشش کریں۔",
  ...
  "feedback.coachPerfectEncouragement": "تمام متوقع الفاظ پہچانے گئے۔ اسی پُرسکون رفتار کو برقرار رکھیں اور ایک بار پھر دہرائیں۔",
  "feedback.coachGoodEncouragement": "اچھی کوشش تھی۔ آیت کو ایک ساتھ رکھیں، پھر صرف اس لفظ کی طرف لوٹیں جو نظرثانی کے لیے نشان زد ہے۔",
  "feedback.coachPerfectSpoken": "ہر متوقع لفظ پہچانا گیا۔ {nextStep}",
  "feedback.coachGoodSpoken": "اچھی کوشش تھی۔ {nextStep}",
  "feedback.nextStepRepeatFromWord": "حوالہ آہستہ سنیں، پھر لفظ {word} سے دہرائیں۔",
  "feedback.nextStepReplayReference": "حوالہ ایک بار دھیمی رفتار سے سنیں، پھر آیت انہی توقفات کے ساتھ دہرائیں۔",
  "feedback.focusedInvalidEncouragement": "یہ مرکوز کوشش نشان زدہ لفظ سے جوڑی نہیں جا سکی۔",
  "feedback.focusedInvalidNextStep": "موجودہ آیت کی طرف لوٹیں اور اپنا نشان زدہ لفظ دوبارہ منتخب کریں۔",
  "feedback.focusedInvalidSpoken": "نشان زدہ لفظ کی تصدیق نہیں ہو سکی۔ موجودہ آیت کی طرف لوٹیں اور دوبارہ کوشش کریں۔",
  "feedback.reviewFocusedTargetInvalid": "اصلاح کا ہدف موجودہ آیت سے مطابقت نہیں رکھتا تھا۔",
  "feedback.unavailableEncouragement": "آپ کی ریکارڈنگ موصول ہوئی، لیکن اس کوشش کے لیے لفظ بہ لفظ قابلِ اعتماد نتیجہ دستیاب نہیں ہے۔",
  "feedback.unavailableSpoken": "اس کوشش کے لیے لفظ بہ لفظ قابلِ اعتماد نتیجہ دستیاب نہیں ہے۔ ایک بار پھر سنیں، پھر کسی پُرسکون جگہ دوبارہ ریکارڈ کریں۔",
  "feedback.transcriptionFailedNextStep": "اپنا رابطہ اور مائیکروفون دیکھیں، پھر آیت دوبارہ ریکارڈ کریں۔ یہ جائزہ مکمل نہیں ہو سکا، لیکن آپ ابھی دوبارہ کوشش کر سکتے ہیں۔",
  "feedback.noArabicNextStep": "آیت کسی پُرسکون جگہ دوبارہ پڑھیں۔ مائیکروفون قریب رکھیں اور ایک آیت پُرسکون رفتار سے پڑھیں۔",
  "feedback.focusedRecognisedNext": "متوقع ہدف والا لفظ متن میں پہچانا گیا۔ اب پوری آیت پڑھیں۔",
  "feedback.focusedNotRecognisedNext": "متوقع ہدف والا لفظ نہیں پہچانا گیا۔ نشان زدہ لفظ سنیں، پھر صرف وہی لفظ دوبارہ کہیں۔",
  "feedback.focusedUnclearNext": "مرکوز متن واضح نہیں تھا۔ نشان زدہ لفظ رکھیں اور وہی لفظ دوبارہ کہیں۔",
  "feedback.focusedRecognisedEncouragement": "متوقع لفظ پہچانا گیا۔",
  "feedback.focusedKeepFocusedEncouragement": "اصلاح کو نشان زدہ لفظ پر مرکوز رکھیں۔",
  "feedback.reviewFocusedUnclear": "مرکوز متن نے ہدف والے لفظ کے بارے میں واضح شواہد فراہم نہیں کیے۔",
  "feedback.noteFocusedTargetInvalid": "کوئی آواز، متن، صوتی مشاہدہ یا آیت کا نمبر جانچا نہیں گیا، کیونکہ مرکوز اصلاح کا ہدف درست نہیں تھا۔",
  "feedback.noteFocusedTargetActive": "مرکوز ہدف فعال رہتا ہے۔ آیت کا نمبر نہیں نکالا گیا، اور آواز یا تلفظ کا کوئی دعویٰ نہیں کیا گیا۔",
  "feedback.noteNoWordScore": "اس کوشش کے لیے لفظ کا نمبر نہیں نکالا گیا۔ ایپ ریکارڈنگ کے بٹن رکھے گی تاکہ آپ فوراً دوبارہ کوشش کر سکیں۔",
  "feedback.noteFocusedChecks": "یہ مرکوز نتیجہ صرف یہ دیکھتا ہے کہ متوقع لفظ تحریری متن میں پہچانا گیا یا نہیں۔ یہ آیت کا نمبر نہیں نکالتا اور تلفظ، تجوید، مخرج، مد، غنہ یا حرکات کی صوتی جانچ نہیں کرتا۔",
  "feedback.noteAyahAcoustic": "الفاظ کی یاد دہانی تقریری تحریر پر مبنی ہے۔ اضافی صوتی مشاہدہ اعتماد کی شرط کے ساتھ مشق کی رہنمائی ہے، تجوید، مخارج، لحن، دینی درستی کی تصدیق نہیں، اور نہ اہل استاد کا بدل ہے۔",
  "feedback.noteAyahTranscription": "یہ تقریری تحریر کی بنیاد پر الفاظ یاد رکھنے کی مدد ہے۔ یہ تجوید، مخارج، حروف کی لمبائی، لحن کا فیصلہ نہیں کرتی اور نہ اہل استاد کی جگہ لیتی ہے۔",
