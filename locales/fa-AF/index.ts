...
export const strings: TranslatableStrings = {
  ...
  "tutor.uncertain": "این تلاوت با اطمینان با آیه مطابقت نشد. یک بار دیگر کوشش کنید.",
  "tutor.paused": "وقت بگیرید. هر وقت خواستید بگویید ادامه بدهیم.",
  "tutor.finished": "خوب است. فعلاً همین‌جا بس می‌کنیم.",
  "tutor.stopped": "فعلاً متوقف شدیم.",
  ...
  // درس بدون دست: مایکروفون باز می‌ماند و شاگرد تنها تلاوت می‌کند.
  "handsfree.label": "استاد زنده",
  "handsfree.start": "استاد زنده را شروع کنید",
  "handsfree.privacy": "مایکروفون تنها در جریان همین نشست به کار می‌رود و پس از پایان رها می‌شود. در هیچ وقت دیگری نمی‌شنود.",
  "handsfree.stateIdle": "نمی‌شنود",
  "handsfree.stateListening": "می‌شنوم",
  "handsfree.stateSpeaking": "شما می‌گویید",
  "handsfree.stateChecking": "بررسی می‌کنم",
  "handsfree.stateTeacher": "استاد شما سخن می‌گوید",
  "handsfree.stateReciter": "قاری در حال تلاوت است",
  "handsfree.stateWaiting": "منتظر شما",
  "handsfree.statePaused": "متوقف شده",
  "handsfree.stateMicUnavailable": "مایکروفون در دسترس نیست",
  "handsfree.stateReconnect": "این درس باید دوباره آغاز شود",
  "handsfree.scopeWord": "تنها همان کلمه",
  "handsfree.scopeAyah": "تمام آیت",
  "handsfree.nowYouSayIt": "حالا شما بگویید.",
  "handsfree.listenToTheWord": "به کلمه گوش کنید.",
  "handsfree.goodContinue": "خوب است. ادامه بدهید.",
  "handsfree.carryOn": "از همان جایی که ایستادیم ادامه می‌دهیم.",
  "handsfree.pause": "توقف",
  "handsfree.resume": "ادامه",
  "handsfree.stop": "پایان",
  "handsfree.options": "اگر چیزی درست پیش نرفت",
  "handsfree.repeatTeacher": "دوباره بگویید",
  "handsfree.hearWordAgain": "کلمه را دوباره بشنوید",
  "handsfree.hearAyah": "آیت را بشنوید",
  "handsfree.hint": "یک راهنمایی بدهید",
  "handsfree.speakAloud": "بگذارید استاد بلند سخن بگوید",
  "handsfree.voiceShown": "نشان داده شد، نه گفته — این مرورگر برای زبان شما صدایی ندارد.",
  "handsfree.sessionLost": "درس از دست رفت. دوباره آغازش کنید تا از همین آیت ادامه یابد.",
  "handsfree.restart": "دوباره آغاز",
  "handsfree.micDenied": "به مایکروفون اجازه داده نشد؛ برای تمرین از دکمهٔ ثبت پایین کار بگیرید.",
  "handsfree.micMissing": "هیچ مایکروفونی یافت نشد؛ برای تمرین از دکمهٔ ثبت پایین کار بگیرید.",
  "handsfree.micUnsupported": "این مرورگر توان ثبت ندارد؛ برای تمرین از دکمهٔ ثبت پایین کار بگیرید.",
  "handsfree.vadUnsupported": "این مرورگر توان شنیدن پیوسته را ندارد؛ برای تمرین از دکمهٔ ثبت پایین کار بگیرید.",
  ...
  "notes.previousAttempt": "این یک تلاش قبلی را توصیف می‌کند — درس از آن زمان به پیش رفته است.",
  ...
  "reader.surahBeginning": "آغاز سوره",
  ...
  "qaida.listenLetter": "این حرف را بشنوید",
  "qaida.audioLoading": "ضبط می‌آید…",
  "qaida.audioRetry": "دوباره پخش کن",
  "qaida.audioIdle":
    "یک حرف را انتخاب کنید، تنها یا با حرکت. اینجا تنها ثبت‌هایی پخش می‌شود که استاد واجد شرایط تأیید کرده باشد — بقیه هنوز آماده نیست.",
  "qaida.audioPlaying": "ضبط قاری پخش می‌شود.",
  "qaida.audioUnavailable":
    "این ثبت هنوز افزوده نشده است. صدای مرجع قاعده را استاد واجد شرایط ثبت می‌کند و پیش از شنیدن تأیید می‌شود — برنامه به جای آن عربی را با صدای ساختگی نمی‌خواند.",
  ...
  "recorder.rateLimited": "شما در مدت کوتاه چند بار کوشش بررسی کردید. یک دقیقه صبر کنید، سپس آیت را دوباره بخوانید.",
  ...
  "plan.qaida.afterRecordingCue": "مرور کلمات را دعوت به تمرین بگیرید، بعد پیش از تکرار، قاری واجد شرایط را دوباره گوش کنید.",
  ...
  "plan.tajweed.afterRecordingCue": "با مرور، کلمه‌ای را که جا مانده یا نامطمئن است پیدا کنید، بعد آن بازگشت را با استاد واجد شرایط برای اصلاح تجوید تمرین کنید.",
  ...
  "feedback.coachCopy": "راهنمایی تمرین را بشنوید، بعد برای عربی قرآنی از قاری واجد شرایط استفاده کنید.",
  ...
  "attemptFailure.micTooQuiet": "میکروفون شما صدا را گرفت، اما آن‌قدر ضعیف بود که بررسی نشد. به میکروفون نزدیک‌تر شوید و دوباره کوشش کنید.",
  "attemptFailure.uncertainVerseMatch": "ضبط شما رسید، اما نتوانست با اطمینان با این آیه مطابقت داده شود، پس جایگاه شما تغییر نکرد. آیه را دوباره بگویید.",
  "validation.micPassed": "موفق شد: {browser} یک سیگنال صوتی واقعی ثبت کرد.",
  "validation.micNoAudio": "ناموفق شد: ضبط‌کننده هیچ داده صوتی قابل استفاده تولید نکرد.",
  "validation.micTooQuiet": "ناموفق شد: صدا ضبط شد، اما سیگنال میکروفون بسیار ضعیف بود.",
  "validation.micError": "بررسی اولیه میکروفون ناموفق شد ({name}). دسترسی‌های میکروفون {browser} را بررسی کنید و دوباره کوشش کنید.",
  ...
  "feedback.coachPerfectEncouragement": "همه کلمات مورد انتظار شناخته شدند. همان آهنگ آرام را نگه دارید و یک بار دیگر تکرار کنید.",
  "feedback.coachGoodEncouragement": "تلاش خوبی بود. آیت را یکجا نگه دارید، بعد تنها به کلمه‌ای برگردید که برای مرور نشانی شده است.",
  "feedback.coachPerfectSpoken": "هر کلمهٔ مورد انتظار شناخته شد. {nextStep}",
  "feedback.coachGoodSpoken": "تلاش خوبی بود. {nextStep}",
  "feedback.nextStepRepeatFromWord": "مرجع را آهسته گوش کنید، بعد از کلمهٔ {word} تکرار کنید.",
  "feedback.nextStepReplayReference": "مرجع را یک بار با آهنگ آهسته‌تر گوش کنید، بعد آیت را با همان وقف‌ها تکرار کنید.",
  "feedback.focusedInvalidEncouragement": "این تلاش متمرکز به کلمهٔ نشانی‌شده وصل شده نتوانست.",
  "feedback.focusedInvalidNextStep": "به آیت جاری برگردید و کلمهٔ نشانی‌شدهٔ خود را دوباره انتخاب کنید.",
  "feedback.focusedInvalidSpoken": "کلمهٔ نشانی‌شده تأیید شده نتوانست. به آیت جاری برگردید و دوباره کوشش کنید.",
  "feedback.reviewFocusedTargetInvalid": "هدف اصلاح با آیت جاری مطابقت نداشت.",
  "feedback.unavailableEncouragement": "ضبط شما رسید، اما برای این تلاش نتیجهٔ قابل اعتماد کلمه‌به‌کلمه در دسترس نیست.",
  "feedback.unavailableSpoken": "برای این تلاش نتیجهٔ قابل اعتماد کلمه‌به‌کلمه در دسترس نیست. یک بار دیگر گوش کنید، بعد در جای آرام دوباره ضبط کنید.",
  "feedback.transcriptionFailedNextStep": "اتصال و مایکروفون خود را بررسی کنید، بعد آیت را دوباره ضبط کنید. این بررسی کامل شده نتوانست، اما حالا می‌توانید دوباره کوشش کنید.",
  "feedback.noArabicNextStep": "آیت را در جای آرام دوباره بخوانید. مایکروفون را نزدیک نگه دارید و یک آیت را با آهنگ آرام بخوانید.",
  "feedback.focusedRecognisedNext": "کلمهٔ هدف مورد انتظار در متن شناخته شد. حالا آیت کامل را بخوانید.",
  "feedback.focusedNotRecognisedNext": "کلمهٔ هدف مورد انتظار شناخته نشد. کلمهٔ نشانی‌شده را گوش کنید، بعد تنها همان کلمه را دوباره بگویید.",
  "feedback.focusedUnclearNext": "متن متمرکز روشن نبود. کلمهٔ نشانی‌شده را نگه دارید و دوباره همان کلمه را بگویید.",
  "feedback.focusedRecognisedEncouragement": "کلمهٔ مورد انتظار شناخته شد.",
  "feedback.focusedKeepFocusedEncouragement": "اصلاح را بر کلمهٔ نشانی‌شده متمرکز نگه دارید.",
  "feedback.reviewFocusedUnclear": "متن متمرکز شواهد روشنی دربارهٔ کلمهٔ هدف ارائه نکرد.",
  "feedback.noteFocusedTargetInvalid": "هیچ صدا، متن، یافتهٔ صوتی یا نمرهٔ آیتی ارزیابی نشد، چون هدف اصلاح متمرکز نامعتبر بود.",
  "feedback.noteFocusedTargetActive": "هدف متمرکز فعال می‌ماند. نمرهٔ آیتی حساب نشد و هیچ ادعای صوتی یا تلفظی صورت نگرفت.",
  "feedback.noteNoWordScore": "برای این تلاش نمرهٔ کلمه‌ای حساب نشد. برنامه دکمه‌های ضبط را نگه می‌دارد تا فوراً دوباره کوشش کنید.",
  "feedback.noteFocusedChecks": "این نتیجهٔ متمرکز تنها بررسی می‌کند که آیا کلمهٔ مورد انتظار در رونویسی شناخته شده است یا نه. نمرهٔ آیتی حساب نمی‌کند و تلفظ، تجوید، مخرج، مد، غنه یا حرکات را به‌صورت صوتی ارزیابی نمی‌کند.",
  "feedback.noteAyahAcoustic": "یادآوری کلمات بر رونویسی گفتار استوار است. مشاهدهٔ صوتی اضافی، راهنمایی تمرینیِ مشروط به اطمینان است، نه تأیید تجوید، مخارج، لحن، درستی دینی یا جایگزین استاد واجد شرایط.",
  "feedback.noteAyahTranscription": "این کمکِ یادآوری کلمات بر پایهٔ رونویسی گفتار است. تجوید، مخارج، طول مصوت‌ها، لحن را قضاوت نمی‌کند و جایگزین استاد واجد شرایط نیست.",
