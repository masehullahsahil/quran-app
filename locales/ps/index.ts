...
export const strings: TranslatableStrings = {
  ...
  "tutor.doDone": "بس دی",
    "tutor.recordingNotApplied": "ستاسو ښوونکي هغه ثبت وانه خیست. لوست بیا پیل کړئ.",
  ...
  // بې لاسه لوست: مایکروفون خلاص پاتې کیږي او زده کوونکی یوازې لولي.
  "handsfree.label": "ژوندی ښوونکی",
  "handsfree.start": "ژوندی ښوونکی پیل کړئ",
  "handsfree.privacy": "مایکروفون یوازې د دې غونډې پر مهال کارول کیږي او کله چې پای ته ورسیږئ خوشې کیږي. په بل هر وخت کې نه اوري.",
  "handsfree.stateIdle": "نه اوري",
  "handsfree.stateListening": "اورم",
  "handsfree.stateSpeaking": "تاسو وایاست",
  "handsfree.stateChecking": "کتنه کوم",
  "handsfree.stateTeacher": "ستاسو ښوونکی خبرې کوي",
  "handsfree.stateReciter": "قاري یې لولي",
  "handsfree.stateWaiting": "ستاسو په تمه",
  "handsfree.statePaused": "درول شوی",
  "handsfree.stateMicUnavailable": "مایکروفون نشته",
  "handsfree.stateReconnect": "دا لوست باید بیا پیل شي",
  "handsfree.scopeWord": "یوازې هغه کلمه",
  "handsfree.scopeAyah": "ټول آیت",
  "handsfree.nowYouSayIt": "اوس یې تاسو ووایاست.",
  "handsfree.listenToTheWord": "کلمې ته غوږ ونیسئ.",
  "handsfree.goodContinue": "ښه دي. مخته لاړ شئ.",
  "handsfree.carryOn": "له هغه ځایه چې ودرېدو، مخته ځو.",
  "handsfree.pause": "درول",
  "handsfree.resume": "مخته لاړ شئ",
  "handsfree.stop": "پای",
  "handsfree.options": "که څه سم نه شول",
  "handsfree.repeatTeacher": "بیا یې ووایاست",
  "handsfree.hearWordAgain": "کلمه بیا واورئ",
  "handsfree.hearAyah": "آیت واورئ",
  "handsfree.hint": "لارښوونه راکړئ",
  "handsfree.speakAloud": "پرېږدئ چې ښوونکی په لوړ غږ خبرې وکړي",
  "handsfree.voiceShown": "ښودل شوې، نه ویل شوې — دې براوزر کې ستاسو د ژبې غږ نشته.",
  "handsfree.sessionLost": "لوست له لاسه ووت. بیا یې پیل کړئ، له همدې آیته به مخته لاړ شي.",
  "handsfree.restart": "بیا پیل",
  "handsfree.micDenied": "مایکروفون ته اجازه ورنه کړل شوه، نو د لاندې د ثبت تڼۍ په مرسته تمرین وکړئ.",
  "handsfree.micMissing": "هیڅ مایکروفون و نه موندل شو، نو د لاندې د ثبت تڼۍ په مرسته تمرین وکړئ.",
  "handsfree.micUnsupported": "دا براوزر ثبت نشي کولی، نو د لاندې د ثبت تڼۍ په مرسته تمرین وکړئ.",
  "handsfree.vadUnsupported": "دا براوزر دوامداره اورېدنه نشي کولی، نو د لاندې د ثبت تڼۍ په مرسته تمرین وکړئ.",
  ...
  "qaida.listenLetter": "دا حرف واورئ",
  "qaida.audioLoading": "ثبت راځي…",
  "qaida.audioRetry": "بیا یې وغږوئ",
  "qaida.audioIdle":
    "یو حرف وټاکئ، یوازې یا له حرکت سره. دلته یوازې هغه ثبتونه غږول کېږي چې وړ ښوونکي تایید کړي وي — نور یې لا چمتو نه دي.",
  "qaida.audioPlaying": "د قاري ثبت غږیږي.",
  "qaida.audioUnavailable":
    "دا ثبت لا نه دی اضافه شوی. د قاعدې مرجع غږ د یوه وړ ښوونکي لخوا ثبتېږي او تر اورېدو دمخه تاییدېږي — اپلیکېشن به یې پر ځای عربي په جوړ شوي غږ ونه لولي.",
  ...
  "recorder.rateLimited": "تاسو په لنډ وخت کې څو ځله د کتنې هڅه کړې. یوه دقیقه انتظار وکړئ، بیا آیت بیا ولولئ.",
  ...
  "plan.qaida.afterRecordingCue": "د کلمو کتنه د تمرین بلنه وګڼئ، بیا له تکرار څخه مخکې وړ قاري بیا واورئ.",
  ...
  "plan.tajweed.afterRecordingCue": "له کتنې څخه هغه کلمه ومومئ چې پاتې شوې یا بې باوره ده، بیا دا ستنېدل له وړ استاد سره د تجوید سمون لپاره تمرین کړئ.",
  ...
  "feedback.coachCopy": "د تمرین لارښوونه واورئ، بیا د قرآني عربي لپاره وړ قاري وکاروئ.",
  ...
  "attemptFailure.micTooQuiet": "ستاسو مایکروفون غږ واخیست، خو دومره ټیټ و چې کتل یې ونه شو. مایکروفون ته نږدې شئ او بیا هڅه وکړئ.",
  "attemptFailure.uncertainVerseMatch": "ستاسو ثبت را ورسېد، خو په ډاډ سره له دې آیت سره ونه شو مطابقت، نو ستاسو ځای نه دی بدل شوی. آیت بیا ووایئ.",
  "validation.micPassed": "بریالی شو: {browser} د ریښتینې غږ نښه ونیوله.",
  "validation.micNoAudio": "ناکام شو: ثبتوونکي کوم ګټور غږیز معلومات تولید نه کړل.",
  "validation.micTooQuiet": "ناکام شو: غږ ثبت شو، خو د مایکروفون نښه ډېره ټیټه وه.",
  "validation.micError": "د مایکروفون لومړنۍ کتنه ناکامه شوه ({name}). د {browser} د مایکروفون اجازې وګورئ او بیا هڅه وکړئ.",
  ...
  "feedback.coachPerfectEncouragement": "ټولې ټاکل شوې کلمې وپېژندل شوې. هماغه ارام رفتار وساتئ او یو ځل بیا یې تکرار کړئ.",
  "feedback.coachGoodEncouragement": "ښه هڅه وه. آیت سره وساتئ، بیا یوازې هغه کلمې ته ورستانه شئ چې د کتنې لپاره نښه شوې ده.",
  "feedback.coachPerfectSpoken": "هره ټاکل شوې کلمه وپېژندل شوه. {nextStep}",
  "feedback.coachGoodSpoken": "ښه هڅه وه. {nextStep}",
  "feedback.nextStepRepeatFromWord": "سرچینه په ورو واورئ، بیا له {word} کلمې څخه تکرار کړئ.",
  "feedback.nextStepReplayReference": "سرچینه یو ځل په ورو رفتار واورئ، بیا آیت په هماغو درېدو سره تکرار کړئ.",
  "feedback.focusedInvalidEncouragement": "دا ځانګړې هڅه له نښه شوې کلمې سره ونه نښلول شوه.",
  "feedback.focusedInvalidNextStep": "اوسني آیت ته ورستانه شئ او خپله نښه شوې کلمه بیا وټاکئ.",
  "feedback.focusedInvalidSpoken": "نښه شوې کلمه تایید نه شوه. اوسني آیت ته ورستانه شئ او بیا هڅه وکړئ.",
  "feedback.reviewFocusedTargetInvalid": "د سمون موخه له اوسني آیت سره سمه نه وه.",
  "feedback.unavailableEncouragement": "ستاسو ثبت ترلاسه شو، خو د دې هڅې لپاره د باور وړ کلمه په کلمه پایله نشته.",
  "feedback.unavailableSpoken": "د دې هڅې لپاره د باور وړ کلمه په کلمه پایله نشته. یو ځل بیا واورئ، بیا په ارام ځای کې ثبت بیا وکړئ.",
  "feedback.transcriptionFailedNextStep": "خپله اړیکه او مایکروفون وګورئ، بیا آیت بیا ثبت کړئ. دا کتنه بشپړه نه شوه، خو اوس بیا هڅه کولی شئ.",
  "feedback.noArabicNextStep": "آیت په ارام ځای کې بیا ووایاست. مایکروفون نږدې ونیسئ او یو آیت په ارام رفتار سره ووایاست.",
  "feedback.focusedRecognisedNext": "ټاکل شوې کلمه په متن کې وپېژندل شوه. اوس ټول آیت ووایاست.",
  "feedback.focusedNotRecognisedNext": "ټاکل شوې کلمه ونه پېژندل شوه. نښه شوې کلمه واورئ، بیا یوازې هماغه کلمه ووایاست.",
  "feedback.focusedUnclearNext": "ځانګړی متن روښانه نه و. نښه شوې کلمه وساتئ او بیا یې ووایاست.",
  "feedback.focusedRecognisedEncouragement": "ټاکل شوې کلمه وپېژندل شوه.",
  "feedback.focusedKeepFocusedEncouragement": "سمون پر نښه شوې کلمې متمرکز وساتئ.",
  "feedback.reviewFocusedUnclear": "ځانګړي متن د موخې کلمې په اړه روښانه شواهد نه درلودل.",
  "feedback.noteFocusedTargetInvalid": "هیڅ غږ، متن، صوتي موندنه، یا د آیت نمره ونه ارزول شوه، ځکه د ځانګړي سمون موخه ناسمه وه.",
  "feedback.noteFocusedTargetActive": "ځانګړې موخه فعاله پاتې ده. د آیت نمره نه ده ټاکل شوې، او هیڅ صوتي یا تلفظ ادعا نه ده شوې.",
  "feedback.noteNoWordScore": "د دې هڅې لپاره د کلمې نمره نه ده ټاکل شوې. اپ به د ثبتولو تڼۍ وساتي چې سمدلاسه بیا هڅه وکړئ.",
  "feedback.noteFocusedChecks": "دا ځانګړې پایله یوازې ګوري چې ټاکل شوې کلمه په متن کې پېژندل شوې که نه. دا د آیت نمره نه ټاکي او تلفظ، تجوید، مخرج، مد، غنه، یا حرکات په صوتي ډول نه ارزوي.",
  "feedback.noteAyahAcoustic": "د کلمو یادول په متن پېژندنه ولاړ دي. اضافي صوتي کتنه د باور په کچه د تمرین لارښوونه ده، نه د تجوید، مخارجو، لحن، شرعي سموالي تصدیق، او نه د وړ استاد ځای نیسي.",
  "feedback.noteAyahTranscription": "دا د غږ متن پېژندنې له مخې د کلمو یادولو مرسته ده. دا تجوید، مخارج، د غږونو اوږدوالی، لحن نه ارزوي، او د وړ استاد ځای نه نیسي.",
