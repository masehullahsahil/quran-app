...
export const strings = {
  ...
  "starter.copy": "Learn one letter at a time, hear how it sounds, then practise it with a teacher.",
  ...
  "starter.playLetterLabel": "Play {letter} on its own",
  ...
  "starter.audioAttribution": "Letter audio generated by {source}, until a reciter’s recordings replace it.",
  ...
  "starter.audioPlayingPlaceholder": "Playing a synthesised voice, not a reciter’s recording.",
  ...
  "starter.quickCheckRetry": "Not yet. Look at the letter shape, play the letter again, and try once more.",
