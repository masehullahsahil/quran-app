...
export const strings = {
  ...
  // The hands-free lesson: the microphone stays open, and the learner recites
  // rather than operating a recorder. Every audio state below is a *sentence*,
  // not a colour or an animation, so it reaches a screen reader and survives
  // reduced motion. None of them is a statement about the recitation.
  "handsfree.label": "Live Tutor",
  "handsfree.start": "Start Live Tutor",
  "handsfree.privacy": "The microphone is used only while this session is running, and is released when you finish. It is not listening at any other time.",
  "handsfree.stateIdle": "Not listening",
  "handsfree.stateListening": "Listening",
  "handsfree.stateSpeaking": "You are speaking",
  "handsfree.stateChecking": "Checking",
  "handsfree.stateTeacher": "Your teacher is speaking",
  "handsfree.stateReciter": "The reciter is playing",
  "handsfree.stateWaiting": "Waiting for you",
  "handsfree.statePaused": "Paused",
  "handsfree.stateMicUnavailable": "Microphone unavailable",
  "handsfree.stateReconnect": "This lesson needs to be started again",
  "handsfree.scopeWord": "the one word",
  "handsfree.scopeAyah": "the whole ayah",
  "handsfree.nowYouSayIt": "Now you say it.",
  "handsfree.listenToTheWord": "Listen to the word.",
  "handsfree.goodContinue": "Good. Carry on.",
  "handsfree.carryOn": "Carrying on where we stopped.",
  "handsfree.pause": "Pause",
  "handsfree.resume": "Carry on",
  "handsfree.stop": "Finish",
  "handsfree.options": "If something went wrong",
  "handsfree.repeatTeacher": "Say that again",
  "handsfree.hearWordAgain": "Hear the word again",
  "handsfree.hearAyah": "Hear the ayah",
  "handsfree.hint": "Give me a hint",
  "handsfree.speakAloud": "Let the teacher speak out loud",
  "handsfree.voiceShown": "Shown, not spoken — this browser has no voice for your language.",
  "handsfree.sessionLost": "The lesson was lost. Start it again and it will carry on from this ayah.",
  "handsfree.restart": "Start again",
  "handsfree.micDenied": "The microphone was not allowed, so use the record button below to practise.",
  "handsfree.micMissing": "No microphone was found, so use the record button below to practise.",
  "handsfree.micUnsupported": "This browser cannot record, so use the record button below to practise.",
  "handsfree.vadUnsupported": "This browser cannot listen continuously, so use the record button below to practise.",
  ...
  "attemptFailure.micTooQuiet": "Your microphone picked up sound, but it was too quiet to check. Move closer to the microphone and try again.",
  "attemptFailure.uncertainVerseMatch": "Your recording came through, but it could not be matched confidently to this ayah, so your place has not moved. Try the ayah again.",
  "validation.micPassed": "Passed: {browser} captured a real voice signal.",
  "validation.micNoAudio": "Failed: the recorder produced no usable audio data.",
  "validation.micTooQuiet": "Failed: audio was recorded, but the microphone signal was too quiet.",
  "validation.micError": "Microphone preflight failed ({name}). Check {browser} microphone permissions and try again.",
